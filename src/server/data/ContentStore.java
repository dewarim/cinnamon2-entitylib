...
public class ContentStore {
     ...
     * @return String
     * @throws IOException if something IO-related goes wrong (like disk full)
     */
    // TODO: find a better method name
    public static String copyToContentStore(String sourcePath, String repository) throws IOException {
        Logger log = LoggerFactory.getLogger(server.data.ContentStore.class);
     ...
     * @param repository the repository to which the file belongs
     * @return String
     * @throws IOException if something unexpected and fatal happens (like missing write
     *                     permissions)
     */
