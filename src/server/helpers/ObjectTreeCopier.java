...
public class ObjectTreeCopier {
    ...
    public ObjectSystemData createEmptyCopy(ObjectSystemData osd) {
        ...
        // update the copy's predecessor to mirror the latesthead/latestbranch of the original's predecessor.
        if(predecessor != null && ! predecessor.equals(copy)){
            predecessor.setLatestBranch(osd.getPredecessor().getLatestBranch());
            predecessor.setLatestHead(osd.getPredecessor().getLatestHead());
        }
