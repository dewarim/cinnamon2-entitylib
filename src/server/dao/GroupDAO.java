...
public interface GroupDAO extends GenericDAO<Group, Long> {
    /**
     * Add a user to this group. <em>This creates a GroupUser object!</em>
     *
    ...
    /**
     * @return Group    The personal group of this user.
     */
     ...
     * @return a list of User objects which share the given group.
     */
