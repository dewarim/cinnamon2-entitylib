...
public class HibernateDAOFactory extends DAOFactory {
    ...
    @Override
	public MetasetDAO getMetasetDAO(EntityManager session) {
		return (MetasetDAO) instantiateDAO(MetasetDAOHibernate.class, session);
	}

    @Override
	public MetasetTypeDAO getMetasetTypeDAO(EntityManager session) {
		return (MetasetTypeDAO) instantiateDAO(MetasetTypeDAOHibernate.class, session);
	}
