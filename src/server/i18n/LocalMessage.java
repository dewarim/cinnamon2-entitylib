...
public class LocalMessage implements ILocalizer{
	...
	public static void setLocalLanguage(UiLanguage language){
		LocalMessage.getInstance().get().language = language;
	}
	
	public static void initializeLocalMessage(MessageDAO messageDao, UiLanguage language){
...
//		log.debug("LocalMessage: "+lm);
		Message msg = msgDao.findMessage(message, lm.language);
		if(msg == null){
			return message;
		}
		else{
